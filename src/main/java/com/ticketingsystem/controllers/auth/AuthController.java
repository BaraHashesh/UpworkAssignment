package com.ticketingsystem.controllers.auth;

import com.ticketingsystem.jwt.JwtHelper;
...
/**
 * Controller responsible for handling the JWT generation via the login request
 */
@RestController
@RequestMapping("/auth")
